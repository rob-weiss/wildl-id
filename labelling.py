...
prompt = (
    ...
    "There is a battery symbol somewhere left of the temperature value. Inside the symbol there is either a percentage value or up to four bars indicating the remaining battery level of the camera.\n"
